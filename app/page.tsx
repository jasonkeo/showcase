...
export default function Home() {
  return (
    <main className="flex-grow grid grid-cols-2 gap-4 border-4 border-black-900 w-9/12 mx-auto">
      

      <div className="w-full h-[90vh] bg-blue-500 flex items-center justify-center">

        <div className="w-60/100 bg-yellow-500 text-center">
          <h1 className='text-7xl font-bold'> Join our Social <br></br> Sessions!</h1>
          <br></br>
