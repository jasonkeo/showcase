  ...
  const toggleDropdown = () => {
    ...
    return (
      ...
      <header className="sticky top-0 z-50">
          ...
          <div className= 'justify-center hidden custom:flex'>
          
          </div>
  
          <div className='flex justify-center w-[170px] mx-10 custom:mx-0'>
          <Link href="../"><img src="image.png" alt="logo"></img></Link>
          </div>
  
          
          <div className="justify-between items-center hidden custom:flex">
            <div></div>
          ...
          <div className='justify-center inline-block custom:hidden w-[40px] mx-10'>
